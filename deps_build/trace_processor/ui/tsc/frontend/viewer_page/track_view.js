...
function renderTrackDetailsMenu(node, descriptor) {
    ...
    }), (0, mithril_1.default)(tree_1.TreeNode, { left: 'Path', right: fullPath }), (0, mithril_1.default)(tree_1.TreeNode, { left: 'Title', right: node.title }), descriptor &&
        (0, mithril_1.default)(tree_1.TreeNode, { left: 'Description', right: descriptor?.description }), (0, mithril_1.default)(tree_1.TreeNode, {
        left: 'Workspace',
