    ...
    renderOffsetTimestamp(ctx) {
        ...
        switch (timestampFormat) {
            ...
            case timeline_1.TimestampFormat.Timecode:
                const width = this.renderTimestamp(ctx, offset, 6, 10, gridline_helper_1.MIN_PX_PER_STEP);
            ...
            case timeline_1.TimestampFormat.TraceTz:
                ...
                const timeZone = time_1.Time.formatTimezone(tzOffsetMins);
        ...
        if (size.width > 0 && timespan.duration > 0n) {
            ...
            for (const { type, time } of tickGen) {
                if (type === gridline_helper_1.TickType.MAJOR) {
                    ...
                    this.renderTimestamp(ctx, domainTime, position + 5, 10, gridline_helper_1.MIN_PX_PER_STEP);
                }
            }
        }
    }
    renderTimestamp(ctx, time, x, y, minWidth) {
