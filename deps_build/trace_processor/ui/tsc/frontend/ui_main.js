...
class UiMainPerTrace {
        ...
        const cmds = [
            {
                ...
                callback: async () => {
                    ...
                    const timeZone = time_1.Time.formatTimezone(trace.traceInfo.tzOffMin);
    ...
    view() {
        ...
        return (0, mithril_1.default)(hotkey_context_1.HotkeyContext, { hotkeys }, (0, mithril_1.default)('main', (0, mithril_1.default)(sidebar_1.Sidebar, { trace: this.trace }), (0, mithril_1.default)(topbar_1.Topbar, {
            ...
            trace: this.trace,
        }), app.pages.renderPageForCurrentRoute(), (0, mithril_1.default)(cookie_consent_1.CookieConsent), (0, modal_1.maybeRenderFullscreenModalDialog)(), showStatusBarFlag.get() && (0, statusbar_1.renderStatusBar)(app.trace), app.perfDebugging.renderPerfStats()));
    }
    onupdate({ dom }) {
