...
class PluginsPage {
    ...
    renderPluginCard(plugin) {
        ...
        return (0, mithril_1.default)(card_1.Card, {
            ...
            key: plugin.desc.id,
        }, (0, mithril_1.default)('.pf-plugins-page__details', (0, mithril_1.default)('h1', plugin.desc.id), plugin.desc.description &&
            (0, mithril_1.default)('.pf-plugins-page__description', plugin.desc.description)), (0, mithril_1.default)('.pf-plugins-page__controls', 
