...
exports.createBaseAggregationToTabAdaptor = createBaseAggregationToTabAdaptor;
 ...
 * selection sub-tab.
 */
function createBaseAggregationToTabAdaptor(trace, aggregator, PanelComponent, tabPriorityOverride) {
...
function createAggregationToTabAdaptor(trace, aggregator, tabPriorityOverride) {
    return createBaseAggregationToTabAdaptor(trace, aggregator, aggregation_panel_1.AggregationPanel, tabPriorityOverride);
}
