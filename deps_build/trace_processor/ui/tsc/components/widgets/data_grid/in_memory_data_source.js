...
class InMemoryDataSource {
    ...
    notifyUpdate(sortBy, filters) {
        if (!this.isSortByEqual(sortBy, this.oldSortBy) ||
    ...
    isSortByEqual(a, b) {
        ...
        if (a.direction !== 'unsorted' && b.direction !== 'unsorted') {
            const aColumn = a;
            const bColumn = b;
            return (aColumn.column === bColumn.column &&
    ...
    areFiltersEqual(filtersA, filtersB) {
        ...
        return filtersA.every((filterA, index) => {
            ...
            return (filterA.column === filterB.column &&
...
//# sourceMappingURL=in_memory_data_source.js.map