...
exports.ButtonBar = exports.Button = exports.ButtonVariant = void 0;
...
class Button {
    view({ attrs }) {
        const { icon, active, compact, rightIcon, className, dismissPopup, iconFilled, intent = common_1.Intent.None, variant = ButtonVariant.Minimal, ...htmlAttrs } = attrs;
        const label = 'label' in attrs ? attrs.label : undefined;
        const iconOnly = Boolean(icon && !label);
        const classes = (0, classnames_1.classNames)(active && 'pf-active', compact && 'pf-compact', classForVariant(variant), (0, common_1.classForIntent)(intent), iconOnly && 'pf-icon-only', dismissPopup && popup_1.Popup.DISMISS_POPUP_GROUP_CLASS, className);
        return (0, mithril_1.default)('button.pf-button', {
            ...htmlAttrs,
            className: classes,
        }, this.renderIcon(attrs), label || '\u200B', // Zero width space keeps button in-flow
        rightIcon &&
