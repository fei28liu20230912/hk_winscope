    ...
    return new dataset_slice_track_1.DatasetSliceTrack({
      ...
      `,
            schema: {
                ...
                tag: query_result_1.STR_NULL,
                msg: query_result_1.STR_NULL,
            },
        }),
        initialMaxDepth: 4,
        colorizer: (row) => DEPTH_TO_COLOR[row.depth],
        tooltip: (slice) => [(0, mithril_1.default)('', (0, mithril_1.default)('b', slice.row.tag)), (0, mithril_1.default)('', slice.row.msg)],
