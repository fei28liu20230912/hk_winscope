...
async function getMetricV2(engine, metric, metricId, format) {
    const result = await engine.summarizeTrace([metric], [metricId], undefined, format === 'proto' ? 'proto' : 'prototext');
...
class MetricResultView {
    view({ attrs }) {
        ...
        if (result === undefined) {
            return (0, mithril_1.default)('pre.metric-error', 'No metric provided');
        }
        if (result === 'pending') {
  ...
  group_by: {
    ...
    aggregates: {
      ...
      result_column_name: "avg_rss_and_swap"
        ...
        return (0, mithril_1.default)('.pf-metricsv2-page', (0, mithril_1.default)('.pf-metricsv2-page__metric_id_box', 'Metric id: ', (0, mithril_1.default)(text_input_1.TextInput, {
            value: this.metricId,
            oninput: (e) => {
                if (!e.target)
                    return;
                attrs.onUpdateText();
                this.metricId = e.target.value;
            },
        })), 'Provide metric v2 spec in prototext format ', (0, mithril_1.default)(editor_1.Editor, {
            generation: attrs.editorGeneration,
            initialText: this.text,
            onExecute: (text) => {
                this.text = text;
                getMetricV2(attrs.engine, `metric_spec: {${text}}`, this.metricId, 'prototext')
                    .then((result) => {
...
class MetricsPage {
    ...
    view({ attrs }) {
        ...
        return (0, mithril_1.default)('.metrics-page', (0, mithril_1.default)(segmented_buttons_1.SegmentedButtons, {
            ...
            }), (0, mithril_1.default)(MetricResultView, {
