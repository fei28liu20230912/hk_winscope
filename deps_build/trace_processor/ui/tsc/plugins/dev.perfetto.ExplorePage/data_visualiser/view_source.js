...
const query_node_explorer_1 = require("../query_builder/query_node_explorer");
...
class VisViewSource {
    ...
    async loadBaseQuery() {
        this.sqlAsyncLimiter.schedule(async () => {
            const sql = await (0, query_node_explorer_1.analyzeNode)(this.queryNode, this.trace.engine);
