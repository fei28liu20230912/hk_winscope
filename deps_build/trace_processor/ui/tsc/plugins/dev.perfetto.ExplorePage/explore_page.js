...
function addSourcePopupMenu(attrs) {
    ...
    return [
        (0, mithril_1.default)(menu_1.MenuItem, {
            ...
            onclick: async () => {
                const newNode = new stdlib_table_1.StdlibTableNode({
                    filters: [],
                    sourceCols: [],
                    groupByColumns: [],
                    aggregations: [],
        ...
        (0, mithril_1.default)(menu_1.MenuItem, {
            label: 'Custom slices',
            onclick: () => {
                const newNode = new slices_source_1.SlicesSourceNode({
                    sourceCols: (0, slices_source_1.slicesSourceNodeColumns)(true),
                    filters: [],
                    groupByColumns: (0, slices_source_1.slicesSourceNodeColumns)(false),
                    aggregations: [],
                });
                state.rootNodes.push(newNode);
                state.selectedNode = newNode;
        ...
        (0, mithril_1.default)(menu_1.MenuItem, {
            label: 'Custom SQL',
            onclick: () => {
                const newNode = new sql_source_1.SqlSourceNode({
                    sourceCols: [],
                    filters: [],
                    groupByColumns: [],
                    aggregations: [],
