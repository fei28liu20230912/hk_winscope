    ...
    getDetails() {
        return (0, mithril_1.default)('', (0, mithril_1.default)('', 'Preamble', (0, mithril_1.default)(text_input_1.TextInput, {
            ...
            oninput: (e) => {
                if (!e.target)
                    return;
                this.state.preamble = e.target.value.trim();
            },
            ...
            oninput: (e) => {
                if (!e.target)
                    return;
                this.state.sqlColumns = e.target.value
                    .split(',')
                    .map((col) => col.trim())
                    .filter(Boolean);
                this.state.sourceCols = this.state.sqlColumns.map((c) => (0, column_controller_1.columnControllerRowFromName)(c, true));
