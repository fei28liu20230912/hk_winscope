...
exports.ChromeCategoriesWidget = void 0;
...
function chromeRecordSection(chromeCategoryGetter) {
    return {
        kind: 'PROBES_PAGE',
        id: 'chrome',
...
function chromeProbe(chromeCategoryGetter) {
    const groupToggles = Object.fromEntries(Object.keys(GROUPS).map((groupName) => [
        groupName,
        new toggle_1.Toggle({
            title: groupName,
        }),
...
class ChromeCategoriesWidget {
    chromeCategoryGetter;
    options = new Array();
    fetchedRuntimeCategories = false;
    constructor(chromeCategoryGetter) {
        this.chromeCategoryGetter = chromeCategoryGetter;
    ...
    async fetchRuntimeCategoriesIfNeeded() {
        if (this.fetchedRuntimeCategories)
            return;
    ...
    render() {
        return (0, mithril_1.default)('div.chrome-categories', {
        ...
        }, (0, mithril_1.default)(section_1.Section, { title: 'Additional Categories' }, (0, mithril_1.default)(multiselect_1.MultiSelect, {
...
exports.ChromeCategoriesWidget = ChromeCategoriesWidget;
function defaultAndDisabled(category) {
