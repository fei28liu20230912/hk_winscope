...
class Probe {
    view({ attrs }) {
        ...
        return (0, mithril_1.default)('.probe', {
            ...
            ? ''
            : (0, mithril_1.default)(`div${probe.image ? '' : '.extended-desc'}`, (0, mithril_1.default)('div', formatDescription(probe.description), probe.docsLink && (0, mithril_1.default)(docs_chip_1.DocsChip, { href: probe.docsLink })), (0, mithril_1.default)('.probe-config', Object.values(attrs.probe.settings ?? {}).map((widget) => widget.render()))));
    }
}
exports.Probe = Probe;
