...
class CpuSliceTrack {
    ...
    renderTooltip() {
        ...
        if (hoveredThread.pid !== undefined) {
            ...
            return (0, mithril_1.default)('.tooltip', [(0, mithril_1.default)('div', pidText), (0, mithril_1.default)('div', tidText)]);
        }
        else {
            return (0, mithril_1.default)('.tooltip', tidText);
        }
    }
    render(trackCtx) {
    ...
    `);
        ...
        if (firstRow) {
            return {
                ts: time_1.Time.fromRaw(firstRow.ts),
                dur: firstRow.dur,
            };
        }
        else {
