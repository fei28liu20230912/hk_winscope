...
class ThreadStateDetailsPanel {
    ...
    async load() {
        ...
        const relatedStates = {};
        const prevRelatedStates = await (0, thread_state_1.getThreadStateFromConstraints)(this.trace.engine, {
            filters: [
        ...
        const nextRelatedStates = await (0, thread_state_1.getThreadStateFromConstraints)(this.trace.engine, {
            filters: [
