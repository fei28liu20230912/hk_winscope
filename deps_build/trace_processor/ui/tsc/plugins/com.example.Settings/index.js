...
class default_1 {
    static id = 'com.example.Settings';
    static description = 'Example plugin to show how to register settings.';
    static onActivate(app) {
        ...
        app.settings.register({
            ...
            schema: zod_1.z.number().min(0).max(100),
            defaultValue: 50,
        });
        ...
        app.settings.register({
            ...
            schema: zod_1.z.enum(['high', 'medium', 'low']),
            defaultValue: 'medium',
        });
        ...
        app.settings.register({
            ...
            schema: zod_1.z.object({ foo: zod_1.z.boolean() }),
            defaultValue: { foo: false },
            render: (setting) => {
                return (0, mithril_1.default)('div', [(0, mithril_1.default)('span', JSON.stringify(setting.get()))], (0, mithril_1.default)(button_1.Button, {
        ...
        app.settings.register({
            ...
            description: 'After changing this setting, the user will be prompted to reload.',
            schema: zod_1.z.boolean(),
            defaultValue: false,
            requiresReload: true,
        });
    ...
    async onTraceLoad(trace) {
        ...
        trace.settings.register({
            ...
            description: "A boolean setting that's registered with teh trace rather than the app.",
            schema: zod_1.z.boolean(),
            defaultValue: false,
        });
    }
