...
exports.addLatencyCUJDebugTrack = addLatencyCUJDebugTrack;
 ...
 */
async function addJankCUJDebugTrack(ctx, trackName, cujNames) {
 ...
 * @returns Returns true if the track was added, false otherwise
 */
async function addLatencyCUJDebugTrack(ctx, trackName, cujNames) {
 ...
 * @returns Returns the track config for given CUJs
 */
function generateLatencyCujTrackConfig(cujNames = []) {
 ...
 * @returns Returns the track config for given CUJs
 */
function generateCujTrackConfig(cujNames = [], cujQuery, cujColumns) {
    // This method expects the caller to have run JANK_CUJ_QUERY_PRECONDITIONS
    // Not running the precondition query here to save time in case already run
