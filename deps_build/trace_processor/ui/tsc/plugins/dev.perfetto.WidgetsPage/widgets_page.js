    ...
    view({ attrs }) {
        ...
        a grid.`,
          ...
          like there is one big canvas over the top of the content.`,
            ...
            renderWidget: ({ readonlyFilters, readonlySorting, ...rest }) => (0, mithril_1.default)(DataGridShowcase, {
                ...rest,
            ...
            renderWidget: ({ readonlyFilters, readonlySorting, ...rest }) => {
                ...
                if (trace) {
                    return (0, mithril_1.default)(DataGridSqlShowcase, {
                        ...rest,
                        engine: trace.engine,
                        filters: readonlyFilters ? [] : undefined,
                        sortBy: readonlySorting ? { direction: 'unsorted' } : undefined,
...
function DataGridShowcase() {
    const dataSource = new in_memory_data_source_1.InMemoryDataSource([
        {
            id: 1,
            name: 'foo',
            ts: 123n,
...
function DataGridSqlShowcase(vnode) {
    const dataSource = new sql_data_source_1.SQLDataSource(vnode.attrs.engine, 'SELECT * FROM slice');
    return {
        view({ attrs }) {
            return (0, mithril_1.default)(data_grid_1.DataGrid, {
                ...attrs,
