...
class default_1 {
    static id = 'com.example.Tabs';
    static description = 'Example plugin to show how to register tabs.';
    async onTraceLoad(trace) {
        this.createPersistentTab(trace);
        this.createEphemeralTab(trace);
    }
    createPersistentTab(trace) {
        ...
        trace.tabs.registerTab({
            ...
            content: {
                ...
                render: () => (0, mithril_1.default)('div', 'Hello from the global example tab!'),
            },
        });
    ...
    createEphemeralTab(trace) {
        ...
        trace.tabs.registerTab({
            ...
            content: {
                ...
                render: () => (0, mithril_1.default)('div', 'Hello from the ephemeral example tab!'),
            },
        });
