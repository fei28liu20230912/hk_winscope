...
describe('SettingsManagerImpl', () => {
    ...
    beforeEach(() => {
        ...
        settingsManager = new settings_manager_1.SettingsManagerImpl(mockStorage);
    });
    ...
    test('should handle invalid value in storage during load', () => {
        ...
        settingsManager = new settings_manager_1.SettingsManagerImpl(mockStorage); // Load happens here
        const setting = settingsManager.register(stringSettingDesc);
        // Should fall back to default
        expect(setting.get()).toBe(stringSettingDesc.defaultValue);
        expect(setting.isDefault).toBe(true);
        // Storage should be corrected
        expect(mockStorage.getStoredData()[stringSettingDesc.id]).toBe(stringSettingDesc.defaultValue);
    });
    test('should ignore invalid value during set', () => {
        ...
        setting.set('not a number'); // Invalid type
...
//# sourceMappingURL=settings_manager_unittest.js.map