...
namespace protos {
namespace pbzero {
class AnalyzeStructuredQueryArgs;
class AnalyzeStructuredQueryResult;
class AnalyzeStructuredQueryResult_StructuredQueryResult;
...
class TraceSummaryArgs_ComputationSpec_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
...
class AnalyzeStructuredQueryResult_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  AnalyzeStructuredQueryResult_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit AnalyzeStructuredQueryResult_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit AnalyzeStructuredQueryResult_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_error() const { return at<1>().valid(); }
  ::protozero::ConstChars error() const { return at<1>().as_string(); }
  bool has_results() const { return at<2>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstBytes> results() const { return GetRepeated<::protozero::ConstBytes>(2); }
};

class AnalyzeStructuredQueryResult : public ::protozero::Message {
 public:
  using Decoder = AnalyzeStructuredQueryResult_Decoder;
  enum : int32_t {
    kErrorFieldNumber = 1,
    kResultsFieldNumber = 2,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.AnalyzeStructuredQueryResult"; }

  using StructuredQueryResult = ::perfetto::protos::pbzero::AnalyzeStructuredQueryResult_StructuredQueryResult;
  ...
  static constexpr FieldMetadata_Results kResults{};
  template <typename T = AnalyzeStructuredQueryResult_StructuredQueryResult> T* add_results() {
...
class AnalyzeStructuredQueryResult_StructuredQueryResult_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  ...
  explicit AnalyzeStructuredQueryResult_StructuredQueryResult_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_sql() const { return at<1>().valid(); }
  ::protozero::ConstChars sql() const { return at<1>().as_string(); }
  bool has_textproto() const { return at<4>().valid(); }
  ::protozero::ConstChars textproto() const { return at<4>().as_string(); }
...
class AnalyzeStructuredQueryResult_StructuredQueryResult : public ::protozero::Message {
 public:
  using Decoder = AnalyzeStructuredQueryResult_StructuredQueryResult_Decoder;
  enum : int32_t {
    kSqlFieldNumber = 1,
  ...
  void add_modules(const char* data, size_t size) {
    AppendBytes(FieldMetadata_Modules::kFieldId, data, size);
  }
  void add_modules(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_Modules::kFieldId, chars.data, chars.size);
  }
  void add_modules(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_Modules::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
  ...
  static constexpr FieldMetadata_Preambles kPreambles{};
  void add_preambles(const char* data, size_t size) {
    AppendBytes(FieldMetadata_Preambles::kFieldId, data, size);
  }
  void add_preambles(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_Preambles::kFieldId, chars.data, chars.size);
  }
...
class AnalyzeStructuredQueryArgs_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/1, /*HAS_NONPACKED_REPEATED_FIELDS=*/true> {
 public:
  AnalyzeStructuredQueryArgs_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit AnalyzeStructuredQueryArgs_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit AnalyzeStructuredQueryArgs_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
...
class AnalyzeStructuredQueryArgs : public ::protozero::Message {
 public:
  using Decoder = AnalyzeStructuredQueryArgs_Decoder;
  enum : int32_t {
    kQueriesFieldNumber = 1,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.AnalyzeStructuredQueryArgs"; }
...
class TraceProcessorRpc : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_AnalyzeStructuredQueryArgs =
    ::protozero::proto_utils::FieldMetadata<
      109,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_AnalyzeStructuredQueryArgs kAnalyzeStructuredQueryArgs{};
  template <typename T = AnalyzeStructuredQueryArgs> T* set_analyze_structured_query_args() {
  ...
  using FieldMetadata_AnalyzeStructuredQueryResult =
    ::protozero::proto_utils::FieldMetadata<
      213,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
