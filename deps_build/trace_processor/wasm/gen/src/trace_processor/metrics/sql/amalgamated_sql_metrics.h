...
const char kAndroidAndroidBlockingCallsCujPerFrameMetric[] = R"_d3l1m1t3r_(--
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(   -- call starts in a frame and ends in a frame. It can either be the same frame or a different
   -- frame.
...
R"_d3l1m1t3r_(-- Also check if the frame start or end timestamp falls within the cuj boundary.
WHERE
...
R"_d3l1m1t3r_(  -- Aggregate the count and sum for each blocking call by grouping on CUJ name, blocking
...
R"_d3l1m1t3r_(CREATE PERFETTO VIEW android_blocking_calls_cuj_per_frame_metric_output AS
...
R"_d3l1m1t3r_(                WHERE b.cuj_name = cuj.cuj_name and b.upid = cuj.upid
                GROUP BY b.cuj_name
            )
        )
    )
...
const char kAndroidAndroidGarbageCollectionStats[] = R"_d3l1m1t3r_(--
-- Copyright 2024 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
R"_d3l1m1t3r_(  'heap_allocation_rate', heap_allocation_rate,
...
R"_d3l1m1t3r_(        'gc_running_rate', gc_running_rate,
        'gc_running_efficiency', gc_running_efficiency,
        'gc_during_android_startup_dur', gc_during_android_startup_dur,
        'gc_during_android_startup_rate', gc_during_android_startup_rate,
        'gc_during_android_startup_efficiency', gc_during_android_startup_efficiency
...
R"_d3l1m1t3r_(      'time_activity_thread_main',
...
R"_d3l1m1t3r_(        'compilation_reason', STR_SPLIT(slice_name, ' reason=', 1),
        'summary',
...
R"_d3l1m1t3r_(        AND _is_spans_overlapping(l.ts, l.ts_end, launches.ts, launches.ts_end)
    ),
    'dlopen_file', (
...
R"_d3l1m1t3r_(        SELECT 'Potential CPU contention with another process' AS slow_cause
        WHERE
          get_number_of_cpus() > 2 AND
...
R"_d3l1m1t3r_(        ) > launches.dur * 0.15
...
R"_d3l1m1t3r_(CREATE TABLE trace_trait_table(trace_trait TEXT UNIQUE);
...
R"_d3l1m1t3r_(    FROM _slice_flattened
...
R"_d3l1m1t3r_(          'name', process_name,
...
R"_d3l1m1t3r_(  OR (cuj.ui_thread = thread.utid);
...
const char kAndroidWattsonAppStartupThreads[] = R"_d3l1m1t3r_(
...
const char kAndroidWattsonAtraceAppsThreads[] = R"_d3l1m1t3r_(
-- Copyright 2025 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
const char kCommonCloneDuration[] = R"_d3l1m1t3r_(--
-- Copyright 2022 The Android Open Source Project
--
-- Licensed under the Apache License, Version 2.0 (the "License");
-- you may not use this file except in compliance with the License.
...
const FileToSql kFileToSql[] = {
  ...
  {"android/android_blocking_calls_cuj_per_frame_metric.sql", kAndroidAndroidBlockingCallsCujPerFrameMetric},
  ...
  {"android/android_garbage_collection_stats.sql", kAndroidAndroidGarbageCollectionStats},
  ...
  {"android/wattson_app_startup_threads.sql", kAndroidWattsonAppStartupThreads},

  {"android/wattson_atrace_apps_rails.sql", kAndroidWattsonAtraceAppsRails},

  {"android/wattson_atrace_apps_threads.sql", kAndroidWattsonAtraceAppsThreads},
  ...
  {"common/clone_duration.sql", kCommonCloneDuration},
