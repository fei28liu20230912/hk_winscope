...
(function(global, factory) { /* global define, require, module */
    ...
    var $root = $protobuf.roots.protologudc || ($protobuf.roots.protologudc = {});
    ...
    $root.com = (function() {
        ...
        com.android = (function() {
            ...
            android.internal = (function() {
                ...
                internal.protolog = (function() {
    
                    /**
                     * Namespace protolog.
                     * @memberof com.android.internal
                     * @namespace
                     */
                    var protolog = {};
    
                    protolog.ProtoLogMessage = (function() {
    
                        /**
                         * Properties of a ProtoLogMessage.
                         * @memberof com.android.internal.protolog
                         * @interface IProtoLogMessage
                         * @property {number|null} [messageHashLegacy] ProtoLogMessage messageHashLegacy
                         * @property {Long|null} [elapsedRealtimeNanos] ProtoLogMessage elapsedRealtimeNanos
                         * @property {Array.<string>|null} [strParams] ProtoLogMessage strParams
                         ...
                         * @property {Array.<boolean>|null} [booleanParams] ProtoLogMessage booleanParams
                         * @property {Long|null} [messageHash] ProtoLogMessage messageHash
                         */
                         ...
                         * @constructor
                         * @param {com.android.internal.protolog.IProtoLogMessage=} [properties] Properties to set
                         */
                         ...
                         * @member {number} messageHashLegacy
                         * @memberof com.android.internal.protolog.ProtoLogMessage
                         * @instance
                         */
                        ProtoLogMessage.prototype.messageHashLegacy = 0;
                         ...
                         * @instance
                         */
                        ProtoLogMessage.prototype.elapsedRealtimeNanos = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
                         ...
                         * @instance
                         */
                        ProtoLogMessage.prototype.strParams = $util.emptyArray;
                         ...
                         * @member {Array.<boolean>} booleanParams
                         * @memberof com.android.internal.protolog.ProtoLogMessage
                         * @instance
                         */
                         ...
                         * @member {Long} messageHash
                         * @memberof com.android.internal.protolog.ProtoLogMessage
                         * @instance
                         */
                        ProtoLogMessage.prototype.messageHash = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
                         ...
                         * @static
                         * @param {com.android.internal.protolog.IProtoLogMessage=} [properties] Properties to set
                         * @returns {com.android.internal.protolog.ProtoLogMessage} ProtoLogMessage instance
                         */
                         ...
                         * @memberof com.android.internal.protolog.ProtoLogMessage
                         * @static
                         * @param {com.android.internal.protolog.IProtoLogMessage} message ProtoLogMessage message or plain object to encode
                        ...
                        ProtoLogMessage.encode = function encode(message, writer) {
                            ...
                            if (message.messageHashLegacy != null && Object.hasOwnProperty.call(message, "messageHashLegacy"))
                                writer.uint32(/* id 1, wireType 5 =*/13).sfixed32(message.messageHashLegacy);
                            if (message.elapsedRealtimeNanos != null && Object.hasOwnProperty.call(message, "elapsedRealtimeNanos"))
                                writer.uint32(/* id 2, wireType 1 =*/17).fixed64(message.elapsedRealtimeNanos);
                            ...
                            if (message.sint64Params != null && message.sint64Params.length) {
                                ...
                                for (var i = 0; i < message.sint64Params.length; ++i)
                                    writer.sint64(message.sint64Params[i]);
                                writer.ldelim();
                            }
                            if (message.doubleParams != null && message.doubleParams.length) {
                                writer.uint32(/* id 5, wireType 2 =*/42).fork();
                                for (var i = 0; i < message.doubleParams.length; ++i)
                                    writer.double(message.doubleParams[i]);
                                writer.ldelim();
                            }
                            if (message.booleanParams != null && message.booleanParams.length) {
                                writer.uint32(/* id 6, wireType 2 =*/50).fork();
                                for (var i = 0; i < message.booleanParams.length; ++i)
                                    writer.bool(message.booleanParams[i]);
                                writer.ldelim();
                            }
                            if (message.messageHash != null && Object.hasOwnProperty.call(message, "messageHash"))
                                writer.uint32(/* id 7, wireType 1 =*/57).sfixed64(message.messageHash);
                            return writer;
                        };
                         ...
                         * @returns {com.android.internal.protolog.ProtoLogMessage} ProtoLogMessage
                         * @throws {Error} If the payload is not a reader or valid buffer
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        ProtoLogMessage.decode = function decode(reader, length, error, long) {
                            ...
                            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.com.android.internal.protolog.ProtoLogMessage();
                            while (reader.pos < end) {
                                ...
                                switch (tag >>> 3) {
                                case 1: {
                                        message.messageHashLegacy = reader.sfixed32();
                                        break;
                                    }
                                case 2: {
                                        message.elapsedRealtimeNanos = reader.fixed64();
                                        break;
                                    }
                                case 3: {
                                ...
                                case 6: {
                                        ...
                                        if ((tag & 7) === 2) {
                                            var end2 = reader.uint32() + reader.pos;
                                            while (reader.pos < end2)
                                                message.booleanParams.push(reader.bool());
                                        } else
                                            message.booleanParams.push(reader.bool());
                                        break;
                                    }
                                case 7: {
                                        message.messageHash = reader.sfixed64();
                                        break;
                                    }
                                default:
                         ...
                         */
                        ProtoLogMessage.verify = function verify(message, long) {
                            ...
                            if (message.messageHashLegacy != null && message.hasOwnProperty("messageHashLegacy"))
                                if (!$util.isInteger(message.messageHashLegacy))
                                    return "messageHashLegacy: integer expected";
                            ...
                            if (message.booleanParams != null && message.hasOwnProperty("booleanParams")) {
                                ...
                                for (var i = 0; i < message.booleanParams.length; ++i)
                                    if (typeof message.booleanParams[i] !== "boolean")
                                        return "booleanParams: boolean[] expected";
                            }
                            if (message.messageHash != null && message.hasOwnProperty("messageHash"))
                                if (!$util.isInteger(message.messageHash) && !(message.messageHash && $util.isInteger(message.messageHash.low) && $util.isInteger(message.messageHash.high)))
                                    return "messageHash: integer|Long expected";
                            return null;
                        };
                         ...
                         * @returns {com.android.internal.protolog.ProtoLogMessage} ProtoLogMessage
                         */
                        ProtoLogMessage.fromObject = function fromObject(object, long) {
                            if (object instanceof $root.com.android.internal.protolog.ProtoLogMessage)
                                return object;
                            if (long === undefined)
                                long = 0;
                            if (long > $util.recursionLimit)
                                throw Error("maximum nesting depth exceeded");
                            var message = new $root.com.android.internal.protolog.ProtoLogMessage();
                            if (object.messageHashLegacy != null)
                                message.messageHashLegacy = object.messageHashLegacy | 0;
                            ...
                            if (object.strParams) {
                                if (!Array.isArray(object.strParams))
                                    throw TypeError(".com.android.internal.protolog.ProtoLogMessage.strParams: array expected");
                                message.strParams = [];
                            ...
                            if (object.sint64Params) {
                                if (!Array.isArray(object.sint64Params))
                                    throw TypeError(".com.android.internal.protolog.ProtoLogMessage.sint64Params: array expected");
                                message.sint64Params = [];
                            ...
                            if (object.doubleParams) {
                                if (!Array.isArray(object.doubleParams))
                                    throw TypeError(".com.android.internal.protolog.ProtoLogMessage.doubleParams: array expected");
                                message.doubleParams = [];
                            ...
                            if (object.booleanParams) {
                                if (!Array.isArray(object.booleanParams))
                                    throw TypeError(".com.android.internal.protolog.ProtoLogMessage.booleanParams: array expected");
                                message.booleanParams = [];
                                for (var i = 0; i < object.booleanParams.length; ++i)
                                    message.booleanParams[i] = Boolean(object.booleanParams[i]);
                            }
                            if (object.messageHash != null)
                                if ($util.Long)
                                    (message.messageHash = $util.Long.fromValue(object.messageHash)).unsigned = false;
                                else if (typeof object.messageHash === "string")
                                    message.messageHash = parseInt(object.messageHash, 10);
                                else if (typeof object.messageHash === "number")
                                    message.messageHash = object.messageHash;
                                else if (typeof object.messageHash === "object")
                                    message.messageHash = new $util.LongBits(object.messageHash.low >>> 0, object.messageHash.high >>> 0).toNumber();
                            return message;
                        };
                         ...
                         * @memberof com.android.internal.protolog.ProtoLogMessage
                         * @static
                         * @param {com.android.internal.protolog.ProtoLogMessage} message ProtoLogMessage
                        ...
                        ProtoLogMessage.toObject = function toObject(message, options) {
                            ...
                            if (options.defaults) {
                                ...
                                if ($util.Long) {
                                    var long = new $util.Long(0, 0, false);
                                    object.messageHash = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                                } else
                                    object.messageHash = options.longs === String ? "0" : 0;
                            }
                            if (message.messageHashLegacy != null && message.hasOwnProperty("messageHashLegacy"))
                                object.messageHashLegacy = message.messageHashLegacy;
                            if (message.elapsedRealtimeNanos != null && message.hasOwnProperty("elapsedRealtimeNanos"))
                            ...
                            if (message.messageHash != null && message.hasOwnProperty("messageHash"))
                                if (typeof message.messageHash === "number")
                                    object.messageHash = options.longs === String ? String(message.messageHash) : message.messageHash;
                                else
                                    object.messageHash = options.longs === String ? $util.Long.prototype.toString.call(message.messageHash) : options.longs === Number ? new $util.LongBits(message.messageHash.low >>> 0, message.messageHash.high >>> 0).toNumber() : message.messageHash;
                            return object;
                        };
                        ...
                        ProtoLogMessage.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                            ...
                            return typeUrlPrefix + "/com.android.internal.protolog.ProtoLogMessage";
                        };
    
                        return ProtoLogMessage;
                    })();
    
                    protolog.ProtoLogFileProto = (function() {
    
                        /**
                         * Properties of a ProtoLogFileProto.
                         * @memberof com.android.internal.protolog
                         * @interface IProtoLogFileProto
                         * @property {Long|null} [magicNumber] ProtoLogFileProto magicNumber
                         * @property {string|null} [version] ProtoLogFileProto version
                         * @property {Long|null} [realTimeToElapsedTimeOffsetMillis] ProtoLogFileProto realTimeToElapsedTimeOffsetMillis
                         * @property {Array.<com.android.internal.protolog.IProtoLogMessage>|null} [log] ProtoLogFileProto log
                         */
    
                        /**
                         * Constructs a new ProtoLogFileProto.
                         * @memberof com.android.internal.protolog
                         * @classdesc Represents a ProtoLogFileProto.
                         * @implements IProtoLogFileProto
                         * @constructor
                         * @param {com.android.internal.protolog.IProtoLogFileProto=} [properties] Properties to set
                         */
                        function ProtoLogFileProto(properties) {
                            this.log = [];
                            if (properties)
                                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                                    if (properties[keys[i]] != null && keys[i] !== "__proto__")
                         ...
                         * @memberof com.android.internal.protolog.ProtoLogFileProto
                         * @instance
                         */
                        ProtoLogFileProto.prototype.magicNumber = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
                         ...
                         * @instance
                         */
                        ProtoLogFileProto.prototype.version = "";
    
                        /**
                         * ProtoLogFileProto realTimeToElapsedTimeOffsetMillis.
                         * @member {Long} realTimeToElapsedTimeOffsetMillis
                         * @memberof com.android.internal.protolog.ProtoLogFileProto
                         * @instance
                         */
                        ProtoLogFileProto.prototype.realTimeToElapsedTimeOffsetMillis = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
    
                        /**
                         * ProtoLogFileProto log.
                         * @member {Array.<com.android.internal.protolog.IProtoLogMessage>} log
                         * @memberof com.android.internal.protolog.ProtoLogFileProto
                         * @instance
                         */
                        ProtoLogFileProto.prototype.log = $util.emptyArray;
                         ...
                         * @static
                         * @param {com.android.internal.protolog.IProtoLogFileProto=} [properties] Properties to set
                         * @returns {com.android.internal.protolog.ProtoLogFileProto} ProtoLogFileProto instance
                         */
                        ProtoLogFileProto.create = function create(properties) {
                            return new ProtoLogFileProto(properties);
                        };
                         ...
                         * @memberof com.android.internal.protolog.ProtoLogFileProto
                         * @static
                         * @param {com.android.internal.protolog.IProtoLogFileProto} message ProtoLogFileProto message or plain object to encode
                         * @param {$protobuf.Writer} [writer] Writer to encode to
                         * @returns {$protobuf.Writer} Writer
                         */
                        ProtoLogFileProto.encode = function encode(message, writer) {
                            if (!writer)
                                writer = $Writer.create();
                            ...
                            if (message.realTimeToElapsedTimeOffsetMillis != null && Object.hasOwnProperty.call(message, "realTimeToElapsedTimeOffsetMillis"))
                                writer.uint32(/* id 3, wireType 1 =*/25).fixed64(message.realTimeToElapsedTimeOffsetMillis);
                            if (message.log != null && message.log.length)
                                for (var i = 0; i < message.log.length; ++i)
                                    $root.com.android.internal.protolog.ProtoLogMessage.encode(message.log[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                            return writer;
                        };
                         ...
                         * @returns {$protobuf.Writer} Writer
                         */
                        ProtoLogFileProto.encodeDelimited = function encodeDelimited(message, writer) {
                            return this.encode(message, writer).ldelim();
                        };
                         ...
                         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                         * @param {number} [length] Message length if known beforehand
                         * @returns {com.android.internal.protolog.ProtoLogFileProto} ProtoLogFileProto
                         * @throws {Error} If the payload is not a reader or valid buffer
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        ProtoLogFileProto.decode = function decode(reader, length, error, long) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                            if (long === undefined)
                                long = 0;
                            if (long > $Reader.recursionLimit)
                                throw Error("maximum nesting depth exceeded");
                            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.com.android.internal.protolog.ProtoLogFileProto();
                            while (reader.pos < end) {
                                var tag = reader.uint32();
                                if (tag === error)
                                    break;
                                ...
                                case 3: {
                                        message.realTimeToElapsedTimeOffsetMillis = reader.fixed64();
                                        break;
                                    }
                                case 4: {
                                        if (!(message.log && message.log.length))
                                            message.log = [];
                                        message.log.push($root.com.android.internal.protolog.ProtoLogMessage.decode(reader, reader.uint32(), undefined, long + 1));
                                        break;
                                    }
                                default:
                                    reader.skipType(tag & 7, long);
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        ProtoLogFileProto.decodeDelimited = function decodeDelimited(reader) {
                            if (!(reader instanceof $Reader))
                                reader = new $Reader(reader);
                            return this.decode(reader, reader.uint32());
                        };
                         ...
                         * @returns {string|null} `null` if valid, otherwise the reason why it is not
                         */
                        ProtoLogFileProto.verify = function verify(message, long) {
                            if (typeof message !== "object" || message === null)
                                return "object expected";
                            if (long === undefined)
                                long = 0;
                            ...
                            if (message.realTimeToElapsedTimeOffsetMillis != null && message.hasOwnProperty("realTimeToElapsedTimeOffsetMillis"))
                                if (!$util.isInteger(message.realTimeToElapsedTimeOffsetMillis) && !(message.realTimeToElapsedTimeOffsetMillis && $util.isInteger(message.realTimeToElapsedTimeOffsetMillis.low) && $util.isInteger(message.realTimeToElapsedTimeOffsetMillis.high)))
                                    return "realTimeToElapsedTimeOffsetMillis: integer|Long expected";
                            if (message.log != null && message.hasOwnProperty("log")) {
                                if (!Array.isArray(message.log))
                                    return "log: array expected";
                                for (var i = 0; i < message.log.length; ++i) {
                                    var error = $root.com.android.internal.protolog.ProtoLogMessage.verify(message.log[i], long + 1);
                                    if (error)
                                        return "log." + error;
                                }
                            }
                         ...
                         * @returns {com.android.internal.protolog.ProtoLogFileProto} ProtoLogFileProto
                         */
                        ProtoLogFileProto.fromObject = function fromObject(object, long) {
                            if (object instanceof $root.com.android.internal.protolog.ProtoLogFileProto)
                                return object;
                            if (long === undefined)
                                long = 0;
                            if (long > $util.recursionLimit)
                                throw Error("maximum nesting depth exceeded");
                            var message = new $root.com.android.internal.protolog.ProtoLogFileProto();
                            ...
                            if (object.realTimeToElapsedTimeOffsetMillis != null)
                                if ($util.Long)
                                    (message.realTimeToElapsedTimeOffsetMillis = $util.Long.fromValue(object.realTimeToElapsedTimeOffsetMillis)).unsigned = false;
                                else if (typeof object.realTimeToElapsedTimeOffsetMillis === "string")
                                    message.realTimeToElapsedTimeOffsetMillis = parseInt(object.realTimeToElapsedTimeOffsetMillis, 10);
                                else if (typeof object.realTimeToElapsedTimeOffsetMillis === "number")
                                    message.realTimeToElapsedTimeOffsetMillis = object.realTimeToElapsedTimeOffsetMillis;
                                else if (typeof object.realTimeToElapsedTimeOffsetMillis === "object")
                                    message.realTimeToElapsedTimeOffsetMillis = new $util.LongBits(object.realTimeToElapsedTimeOffsetMillis.low >>> 0, object.realTimeToElapsedTimeOffsetMillis.high >>> 0).toNumber();
                            if (object.log) {
                                if (!Array.isArray(object.log))
                                    throw TypeError(".com.android.internal.protolog.ProtoLogFileProto.log: array expected");
                                message.log = [];
                                for (var i = 0; i < object.log.length; ++i) {
                                    if (typeof object.log[i] !== "object")
                                        throw TypeError(".com.android.internal.protolog.ProtoLogFileProto.log: object expected");
                                    message.log[i] = $root.com.android.internal.protolog.ProtoLogMessage.fromObject(object.log[i], long + 1);
                                }
                            }
                            return message;
                        };
                         ...
                         * @memberof com.android.internal.protolog.ProtoLogFileProto
                         * @static
                         * @param {com.android.internal.protolog.ProtoLogFileProto} message ProtoLogFileProto
                         * @param {$protobuf.IConversionOptions} [options] Conversion options
                         * @returns {Object.<string,*>} Plain object
                         */
                        ProtoLogFileProto.toObject = function toObject(message, options) {
                            if (!options)
                                options = {};
                            var object = {};
                            if (options.arrays || options.defaults)
                            ...
                            if (options.defaults) {
                                ...
                                if ($util.Long) {
                                    var long = new $util.Long(0, 0, false);
                                    object.realTimeToElapsedTimeOffsetMillis = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                                } else
                                    object.realTimeToElapsedTimeOffsetMillis = options.longs === String ? "0" : 0;
                            }
                            if (message.magicNumber != null && message.hasOwnProperty("magicNumber"))
                            ...
                            if (message.realTimeToElapsedTimeOffsetMillis != null && message.hasOwnProperty("realTimeToElapsedTimeOffsetMillis"))
                                if (typeof message.realTimeToElapsedTimeOffsetMillis === "number")
                                    object.realTimeToElapsedTimeOffsetMillis = options.longs === String ? String(message.realTimeToElapsedTimeOffsetMillis) : message.realTimeToElapsedTimeOffsetMillis;
                                else
                                    object.realTimeToElapsedTimeOffsetMillis = options.longs === String ? $util.Long.prototype.toString.call(message.realTimeToElapsedTimeOffsetMillis) : options.longs === Number ? new $util.LongBits(message.realTimeToElapsedTimeOffsetMillis.low >>> 0, message.realTimeToElapsedTimeOffsetMillis.high >>> 0).toNumber() : message.realTimeToElapsedTimeOffsetMillis;
                            if (message.log && message.log.length) {
                                object.log = [];
                                for (var j = 0; j < message.log.length; ++j)
                                    object.log[j] = $root.com.android.internal.protolog.ProtoLogMessage.toObject(message.log[j], options);
                            }
                            return object;
                        };
                         ...
                         * @returns {Object.<string,*>} JSON object
                         */
                        ProtoLogFileProto.prototype.toJSON = function toJSON() {
                            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                        };
                         ...
                         * @returns {string} The default type url
                         */
                        ProtoLogFileProto.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                            if (typeUrlPrefix === undefined) {
                                typeUrlPrefix = "type.googleapis.com";
                            }
                            return typeUrlPrefix + "/com.android.internal.protolog.ProtoLogFileProto";
                        };
    
                        /**
                         * MagicNumber enum.
                         * @name com.android.internal.protolog.ProtoLogFileProto.MagicNumber
                         * @enum {number}
                         * @property {number} INVALID=0 INVALID value
                         * @property {number} MAGIC_NUMBER_L=1414484560 MAGIC_NUMBER_L value
                         * @property {number} MAGIC_NUMBER_H=1196379215 MAGIC_NUMBER_H value
                         */
                        ProtoLogFileProto.MagicNumber = (function() {
                            var valuesById = {}, values = Object.create(valuesById);
                            values[valuesById[0] = "INVALID"] = 0;
                            values[valuesById[1414484560] = "MAGIC_NUMBER_L"] = 1414484560;
                            values[valuesById[1196379215] = "MAGIC_NUMBER_H"] = 1196379215;
                            return values;
                        })();
    
                        return ProtoLogFileProto;
                    })();
    ...
    $root.android = (function() {
         ...
         * @enum {number}
         * @property {number} DEST_LOCAL=0 DEST_LOCAL value
         * @property {number} DEST_EXPLICIT=100 DEST_EXPLICIT value
         * @property {number} DEST_AUTOMATIC=200 DEST_AUTOMATIC value
         * @property {number} DEST_UNSET=255 DEST_UNSET value
         */
        android.Destination = (function() {
            var valuesById = {}, values = Object.create(valuesById);
            values[valuesById[0] = "DEST_LOCAL"] = 0;
            values[valuesById[100] = "DEST_EXPLICIT"] = 100;
            values[valuesById[200] = "DEST_AUTOMATIC"] = 200;
            values[valuesById[255] = "DEST_UNSET"] = 255;
            return values;
        })();
    
        android.PrivacyFlags = (function() {
    
            /**
             * Properties of a PrivacyFlags.
             * @memberof android
             * @interface IPrivacyFlags
             * @property {android.Destination|null} [dest] PrivacyFlags dest
             * @property {Array.<string>|null} [patterns] PrivacyFlags patterns
             */
    
            /**
             * Constructs a new PrivacyFlags.
             * @memberof android
             * @classdesc Represents a PrivacyFlags.
             * @implements IPrivacyFlags
             * @constructor
             * @param {android.IPrivacyFlags=} [properties] Properties to set
             */
            function PrivacyFlags(properties) {
                this.patterns = [];
                if (properties)
                    for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null && keys[i] !== "__proto__")
            ...
            /**
             * PrivacyFlags dest.
             * @member {android.Destination} dest
             * @memberof android.PrivacyFlags
             * @instance
             */
            PrivacyFlags.prototype.dest = 255;
             ...
             * @instance
             */
            PrivacyFlags.prototype.patterns = $util.emptyArray;
             ...
             * @static
             * @param {android.IPrivacyFlags=} [properties] Properties to set
             * @returns {android.PrivacyFlags} PrivacyFlags instance
             */
            PrivacyFlags.create = function create(properties) {
                return new PrivacyFlags(properties);
            };
             ...
             * @memberof android.PrivacyFlags
             * @static
             * @param {android.IPrivacyFlags} message PrivacyFlags message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            PrivacyFlags.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.dest != null && Object.hasOwnProperty.call(message, "dest"))
                    writer.uint32(/* id 1, wireType 0 =*/8).int32(message.dest);
                if (message.patterns != null && message.patterns.length)
                    for (var i = 0; i < message.patterns.length; ++i)
                        writer.uint32(/* id 2, wireType 2 =*/18).string(message.patterns[i]);
                return writer;
            };
             ...
             * @returns {$protobuf.Writer} Writer
             */
            PrivacyFlags.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {android.PrivacyFlags} PrivacyFlags
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            PrivacyFlags.decode = function decode(reader, length, error, long) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                if (long === undefined)
                    long = 0;
                if (long > $Reader.recursionLimit)
                    throw Error("maximum nesting depth exceeded");
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.android.PrivacyFlags();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            PrivacyFlags.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
             ...
             * @returns {string|null} `null` if valid, otherwise the reason why it is not
             */
            PrivacyFlags.verify = function verify(message, long) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (long === undefined)
                    long = 0;
                ...
                if (message.dest != null && message.hasOwnProperty("dest"))
                    switch (message.dest) {
                    default:
                        return "dest: enum value expected";
                    case 0:
                    case 100:
                    case 200:
                    case 255:
             ...
             * @returns {android.PrivacyFlags} PrivacyFlags
             */
            PrivacyFlags.fromObject = function fromObject(object, long) {
                if (object instanceof $root.android.PrivacyFlags)
                    return object;
                if (long === undefined)
                    long = 0;
                if (long > $util.recursionLimit)
                    throw Error("maximum nesting depth exceeded");
                var message = new $root.android.PrivacyFlags();
                switch (object.dest) {
                case "DEST_LOCAL":
                case 0:
                    message.dest = 0;
                ...
                if (object.patterns) {
                    if (!Array.isArray(object.patterns))
                        throw TypeError(".android.PrivacyFlags.patterns: array expected");
                    message.patterns = [];
             ...
             * @memberof android.PrivacyFlags
             * @static
             * @param {android.PrivacyFlags} message PrivacyFlags
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            PrivacyFlags.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                var object = {};
                if (options.arrays || options.defaults)
                    object.patterns = [];
                if (options.defaults)
                    object.dest = options.enums === String ? "DEST_UNSET" : 255;
                if (message.dest != null && message.hasOwnProperty("dest"))
                    object.dest = options.enums === String ? $root.android.Destination[message.dest] === undefined ? message.dest : $root.android.Destination[message.dest] : message.dest;
                if (message.patterns && message.patterns.length) {
                    object.patterns = [];
             ...
             * @returns {Object.<string,*>} JSON object
             */
            PrivacyFlags.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };
             ...
             * @returns {string} The default type url
             */
            PrivacyFlags.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/android.PrivacyFlags";
            };
    ...
    $root.google = (function() {
        ...
        google.protobuf = (function() {
            ...
            protobuf.MessageOptions = (function() {
                 ...
                 * @property {android.IPrivacyFlags|null} [".android.msgPrivacy"] MessageOptions .android.msgPrivacy
                 */
                 ...
                 * @member {android.IPrivacyFlags|null|undefined} .android.msgPrivacy
                 * @memberof google.protobuf.MessageOptions
                 * @instance
                 */
                MessageOptions.prototype[".android.msgPrivacy"] = null;
                ...
                MessageOptions.encode = function encode(message, writer) {
                    ...
                    if (message.uninterpretedOption != null && message.uninterpretedOption.length)
                        for (var i = 0; i < message.uninterpretedOption.length; ++i)
                            $root.google.protobuf.UninterpretedOption.encode(message.uninterpretedOption[i], writer.uint32(/* id 999, wireType 2 =*/7994).fork()).ldelim();
                    if (message[".android.msgPrivacy"] != null && Object.hasOwnProperty.call(message, ".android.msgPrivacy"))
                        $root.android.PrivacyFlags.encode(message[".android.msgPrivacy"], writer.uint32(/* id 102672883, wireType 2 =*/821383066).fork()).ldelim();
                    return writer;
                };
                ...
                MessageOptions.decode = function decode(reader, length, error, long) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 102672883: {
                                message[".android.msgPrivacy"] = $root.android.PrivacyFlags.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        default:
                            reader.skipType(tag & 7, long);
                ...
                MessageOptions.verify = function verify(message, long) {
                    ...
                    if (message[".android.msgPrivacy"] != null && message.hasOwnProperty(".android.msgPrivacy")) {
                        var error = $root.android.PrivacyFlags.verify(message[".android.msgPrivacy"], long + 1);
                        if (error)
                            return ".android.msgPrivacy." + error;
                    }
                    return null;
                };
                ...
                MessageOptions.fromObject = function fromObject(object, long) {
                    ...
                    if (object[".android.msgPrivacy"] != null) {
                        if (typeof object[".android.msgPrivacy"] !== "object")
                            throw TypeError(".google.protobuf.MessageOptions..android.msgPrivacy: object expected");
                        message[".android.msgPrivacy"] = $root.android.PrivacyFlags.fromObject(object[".android.msgPrivacy"], long + 1);
                    }
                    return message;
                };
                ...
                MessageOptions.toObject = function toObject(message, options) {
                    ...
                    if (options.defaults) {
                        ...
                        object.features = null;
                        object[".android.msgPrivacy"] = null;
                    }
                    if (message.messageSetWireFormat != null && message.hasOwnProperty("messageSetWireFormat"))
                    ...
                    if (message[".android.msgPrivacy"] != null && message.hasOwnProperty(".android.msgPrivacy"))
                        object[".android.msgPrivacy"] = $root.android.PrivacyFlags.toObject(message[".android.msgPrivacy"], options);
                    return object;
                };
            ...
            protobuf.FieldOptions = (function() {
                 ...
                 * @property {android.IPrivacyFlags|null} [".android.privacy"] FieldOptions .android.privacy
                 */
                 ...
                 * @member {android.IPrivacyFlags|null|undefined} .android.privacy
                 * @memberof google.protobuf.FieldOptions
                 * @instance
                 */
                FieldOptions.prototype[".android.privacy"] = null;
                ...
                FieldOptions.encode = function encode(message, writer) {
                    ...
                    if (message.uninterpretedOption != null && message.uninterpretedOption.length)
                        for (var i = 0; i < message.uninterpretedOption.length; ++i)
                            $root.google.protobuf.UninterpretedOption.encode(message.uninterpretedOption[i], writer.uint32(/* id 999, wireType 2 =*/7994).fork()).ldelim();
                    if (message[".android.privacy"] != null && Object.hasOwnProperty.call(message, ".android.privacy"))
                        $root.android.PrivacyFlags.encode(message[".android.privacy"], writer.uint32(/* id 102672883, wireType 2 =*/821383066).fork()).ldelim();
                    return writer;
                };
                ...
                FieldOptions.decode = function decode(reader, length, error, long) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 102672883: {
                                message[".android.privacy"] = $root.android.PrivacyFlags.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        default:
                            reader.skipType(tag & 7, long);
                ...
                FieldOptions.verify = function verify(message, long) {
                    ...
                    if (message[".android.privacy"] != null && message.hasOwnProperty(".android.privacy")) {
                        var error = $root.android.PrivacyFlags.verify(message[".android.privacy"], long + 1);
                        if (error)
                            return ".android.privacy." + error;
                    }
                    return null;
                };
                ...
                FieldOptions.fromObject = function fromObject(object, long) {
                    ...
                    if (object[".android.privacy"] != null) {
                        if (typeof object[".android.privacy"] !== "object")
                            throw TypeError(".google.protobuf.FieldOptions..android.privacy: object expected");
                        message[".android.privacy"] = $root.android.PrivacyFlags.fromObject(object[".android.privacy"], long + 1);
                    }
                    return message;
                };
                ...
                FieldOptions.toObject = function toObject(message, options) {
                    ...
                    if (message[".android.privacy"] != null && message.hasOwnProperty(".android.privacy"))
                        object[".android.privacy"] = $root.android.PrivacyFlags.toObject(message[".android.privacy"], options);
                    return object;
                };
