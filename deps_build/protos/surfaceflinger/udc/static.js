    ...
    $root.android = (function() {
        ...
        android.surfaceflinger = (function() {
            ...
            surfaceflinger.LayersTraceFileProto = (function() {
                 ...
                 */
                LayersTraceFileProto.decode = function decode(reader, length, error, long) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 2: {
                                if (!(message.entry && message.entry.length))
                                    message.entry = [];
                                message.entry.push($root.android.surfaceflinger.LayersTraceProto.decode(reader, reader.uint32(), undefined, long + 1));
                                break;
                            }
                        case 3: {
                 ...
                 */
                LayersTraceFileProto.verify = function verify(message, long) {
                    ...
                    if (message.entry != null && message.hasOwnProperty("entry")) {
                        ...
                        for (var i = 0; i < message.entry.length; ++i) {
                            var error = $root.android.surfaceflinger.LayersTraceProto.verify(message.entry[i], long + 1);
                            if (error)
                                return "entry." + error;
                        }
                    }
                 ...
                 * @returns {android.surfaceflinger.LayersTraceFileProto} LayersTraceFileProto
                 */
                LayersTraceFileProto.fromObject = function fromObject(object, long) {
                    ...
                    if (object.entry) {
                        ...
                        for (var i = 0; i < object.entry.length; ++i) {
                            ...
                            message.entry[i] = $root.android.surfaceflinger.LayersTraceProto.fromObject(object.entry[i], long + 1);
                        }
                    }
            ...
            surfaceflinger.LayersTraceProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                LayersTraceProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                    ...
                    while (reader.pos < end) {
                        ...
                        case 3: {
                                message.layers = $root.android.surfaceflinger.LayersProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 4: {
                        ...
                        case 7: {
                                if (!(message.displays && message.displays.length))
                                    message.displays = [];
                                message.displays.push($root.android.surfaceflinger.DisplayProto.decode(reader, reader.uint32(), undefined, long + 1));
                                break;
                            }
                        case 8: {
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                LayersTraceProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                    ...
                    if (message.layers != null && message.hasOwnProperty("layers")) {
                        var error = $root.android.surfaceflinger.LayersProto.verify(message.layers, long + 1);
                        if (error)
                            return "layers." + error;
                    }
                    ...
                    if (message.displays != null && message.hasOwnProperty("displays")) {
                        ...
                        for (var i = 0; i < message.displays.length; ++i) {
                            var error = $root.android.surfaceflinger.DisplayProto.verify(message.displays[i], long + 1);
                            if (error)
                 ...
                 * @returns {android.surfaceflinger.LayersTraceProto} LayersTraceProto
                 */
                LayersTraceProto.fromObject = function fromObject(object, long) {
                    ...
                    if (object.layers != null) {
                        ...
                        message.layers = $root.android.surfaceflinger.LayersProto.fromObject(object.layers, long + 1);
                    }
                    ...
                    if (object.displays) {
                        ...
                        for (var i = 0; i < object.displays.length; ++i) {
                            ...
                            message.displays[i] = $root.android.surfaceflinger.DisplayProto.fromObject(object.displays[i], long + 1);
                        }
                    }
            ...
            surfaceflinger.LayersProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                LayersProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                    ...
                    while (reader.pos < end) {
                        ...
                        case 1: {
                                if (!(message.layers && message.layers.length))
                                    message.layers = [];
                                message.layers.push($root.android.surfaceflinger.LayerProto.decode(reader, reader.uint32(), undefined, long + 1));
                                break;
                            }
                        default:
                            reader.skipType(tag & 7, long);
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                LayersProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                    ...
                    if (message.layers != null && message.hasOwnProperty("layers")) {
                        ...
                        for (var i = 0; i < message.layers.length; ++i) {
                            var error = $root.android.surfaceflinger.LayerProto.verify(message.layers[i], long + 1);
                            if (error)
                                return "layers." + error;
                        }
                    }
                 ...
                 * @returns {android.surfaceflinger.LayersProto} LayersProto
                 */
                LayersProto.fromObject = function fromObject(object, long) {
                    ...
                    if (object.layers) {
                        ...
                        for (var i = 0; i < object.layers.length; ++i) {
                            ...
                            message.layers[i] = $root.android.surfaceflinger.LayerProto.fromObject(object.layers[i], long + 1);
                        }
                    }
                    return message;
                };
            ...
            surfaceflinger.LayerProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                LayerProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                    ...
                    while (reader.pos < end) {
                        ...
                        case 6: {
                                message.transparentRegion = $root.android.surfaceflinger.RegionProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 7: {
                                message.visibleRegion = $root.android.surfaceflinger.RegionProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 8: {
                                message.damageRegion = $root.android.surfaceflinger.RegionProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 9: {
                        ...
                        case 11: {
                                message.position = $root.android.surfaceflinger.PositionProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 12: {
                                message.requestedPosition = $root.android.surfaceflinger.PositionProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 13: {
                                message.size = $root.android.surfaceflinger.SizeProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 14: {
                                message.crop = $root.android.surfaceflinger.RectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 15: {
                                message.finalCrop = $root.android.surfaceflinger.RectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 16: {
                        ...
                        case 20: {
                                message.color = $root.android.surfaceflinger.ColorProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 21: {
                                message.requestedColor = $root.android.surfaceflinger.ColorProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 22: {
                        ...
                        case 23: {
                                message.transform = $root.android.surfaceflinger.TransformProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 24: {
                                message.requestedTransform = $root.android.surfaceflinger.TransformProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 25: {
                        ...
                        case 27: {
                                message.activeBuffer = $root.android.surfaceflinger.ActiveBufferProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 28: {
                        ...
                        case 30: {
                                message.hwcFrame = $root.android.surfaceflinger.RectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 31: {
                                message.hwcCrop = $root.android.surfaceflinger.FloatRectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 32: {
                        ...
                        case 38: {
                                ...
                                message.barrierLayer.push($root.android.surfaceflinger.BarrierLayerProto.decode(reader, reader.uint32(), undefined, long + 1));
                                break;
                            }
                        case 39: {
                                message.bufferTransform = $root.android.surfaceflinger.TransformProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 40: {
                        ...
                        case 43: {
                                message.effectiveTransform = $root.android.surfaceflinger.TransformProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 44: {
                                message.sourceBounds = $root.android.surfaceflinger.FloatRectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 45: {
                                message.bounds = $root.android.surfaceflinger.FloatRectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 46: {
                                message.screenBounds = $root.android.surfaceflinger.FloatRectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 47: {
                                message.inputWindowInfo = $root.android.surfaceflinger.InputWindowInfoProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 48: {
                                message.cornerRadiusCrop = $root.android.surfaceflinger.FloatRectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 49: {
                        ...
                        case 50: {
                                message.colorTransform = $root.android.surfaceflinger.ColorTransformProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 51: {
                        ...
                        case 54: {
                                if (!(message.blurRegions && message.blurRegions.length))
                                    message.blurRegions = [];
                                message.blurRegions.push($root.android.surfaceflinger.BlurRegion.decode(reader, reader.uint32(), undefined, long + 1));
                                break;
                            }
                        case 55: {
                        ...
                        case 57: {
                                message.destinationFrame = $root.android.surfaceflinger.RectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 58: {
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                LayerProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                    ...
                    if (message.transparentRegion != null && message.hasOwnProperty("transparentRegion")) {
                        var error = $root.android.surfaceflinger.RegionProto.verify(message.transparentRegion, long + 1);
                        if (error)
                            return "transparentRegion." + error;
                    }
                    if (message.visibleRegion != null && message.hasOwnProperty("visibleRegion")) {
                        var error = $root.android.surfaceflinger.RegionProto.verify(message.visibleRegion, long + 1);
                        if (error)
                            return "visibleRegion." + error;
                    }
                    if (message.damageRegion != null && message.hasOwnProperty("damageRegion")) {
                        var error = $root.android.surfaceflinger.RegionProto.verify(message.damageRegion, long + 1);
                        if (error)
                    ...
                    if (message.position != null && message.hasOwnProperty("position")) {
                        var error = $root.android.surfaceflinger.PositionProto.verify(message.position, long + 1);
                        if (error)
                            return "position." + error;
                    }
                    if (message.requestedPosition != null && message.hasOwnProperty("requestedPosition")) {
                        var error = $root.android.surfaceflinger.PositionProto.verify(message.requestedPosition, long + 1);
                        if (error)
                            return "requestedPosition." + error;
                    }
                    if (message.size != null && message.hasOwnProperty("size")) {
                        var error = $root.android.surfaceflinger.SizeProto.verify(message.size, long + 1);
                        if (error)
                            return "size." + error;
                    }
                    if (message.crop != null && message.hasOwnProperty("crop")) {
                        var error = $root.android.surfaceflinger.RectProto.verify(message.crop, long + 1);
                        if (error)
                            return "crop." + error;
                    }
                    if (message.finalCrop != null && message.hasOwnProperty("finalCrop")) {
                        var error = $root.android.surfaceflinger.RectProto.verify(message.finalCrop, long + 1);
                        if (error)
                    ...
                    if (message.color != null && message.hasOwnProperty("color")) {
                        var error = $root.android.surfaceflinger.ColorProto.verify(message.color, long + 1);
                        if (error)
                            return "color." + error;
                    }
                    if (message.requestedColor != null && message.hasOwnProperty("requestedColor")) {
                        var error = $root.android.surfaceflinger.ColorProto.verify(message.requestedColor, long + 1);
                        if (error)
                    ...
                    if (message.transform != null && message.hasOwnProperty("transform")) {
                        var error = $root.android.surfaceflinger.TransformProto.verify(message.transform, long + 1);
                        if (error)
                            return "transform." + error;
                    }
                    if (message.requestedTransform != null && message.hasOwnProperty("requestedTransform")) {
                        var error = $root.android.surfaceflinger.TransformProto.verify(message.requestedTransform, long + 1);
                        if (error)
                    ...
                    if (message.activeBuffer != null && message.hasOwnProperty("activeBuffer")) {
                        var error = $root.android.surfaceflinger.ActiveBufferProto.verify(message.activeBuffer, long + 1);
                        if (error)
                    ...
                    if (message.hwcFrame != null && message.hasOwnProperty("hwcFrame")) {
                        var error = $root.android.surfaceflinger.RectProto.verify(message.hwcFrame, long + 1);
                        if (error)
                            return "hwcFrame." + error;
                    }
                    if (message.hwcCrop != null && message.hasOwnProperty("hwcCrop")) {
                        var error = $root.android.surfaceflinger.FloatRectProto.verify(message.hwcCrop, long + 1);
                        if (error)
                    ...
                    if (message.barrierLayer != null && message.hasOwnProperty("barrierLayer")) {
                        ...
                        for (var i = 0; i < message.barrierLayer.length; ++i) {
                            var error = $root.android.surfaceflinger.BarrierLayerProto.verify(message.barrierLayer[i], long + 1);
                            if (error)
                                return "barrierLayer." + error;
                        }
                    }
                    if (message.bufferTransform != null && message.hasOwnProperty("bufferTransform")) {
                        var error = $root.android.surfaceflinger.TransformProto.verify(message.bufferTransform, long + 1);
                        if (error)
                    ...
                    if (message.effectiveTransform != null && message.hasOwnProperty("effectiveTransform")) {
                        var error = $root.android.surfaceflinger.TransformProto.verify(message.effectiveTransform, long + 1);
                        if (error)
                            return "effectiveTransform." + error;
                    }
                    if (message.sourceBounds != null && message.hasOwnProperty("sourceBounds")) {
                        var error = $root.android.surfaceflinger.FloatRectProto.verify(message.sourceBounds, long + 1);
                        if (error)
                            return "sourceBounds." + error;
                    }
                    if (message.bounds != null && message.hasOwnProperty("bounds")) {
                        var error = $root.android.surfaceflinger.FloatRectProto.verify(message.bounds, long + 1);
                        if (error)
                            return "bounds." + error;
                    }
                    if (message.screenBounds != null && message.hasOwnProperty("screenBounds")) {
                        var error = $root.android.surfaceflinger.FloatRectProto.verify(message.screenBounds, long + 1);
                        if (error)
                            return "screenBounds." + error;
                    }
                    if (message.inputWindowInfo != null && message.hasOwnProperty("inputWindowInfo")) {
                        var error = $root.android.surfaceflinger.InputWindowInfoProto.verify(message.inputWindowInfo, long + 1);
                        if (error)
                            return "inputWindowInfo." + error;
                    }
                    if (message.cornerRadiusCrop != null && message.hasOwnProperty("cornerRadiusCrop")) {
                        var error = $root.android.surfaceflinger.FloatRectProto.verify(message.cornerRadiusCrop, long + 1);
                        if (error)
                    ...
                    if (message.colorTransform != null && message.hasOwnProperty("colorTransform")) {
                        var error = $root.android.surfaceflinger.ColorTransformProto.verify(message.colorTransform, long + 1);
                        if (error)
                    ...
                    if (message.blurRegions != null && message.hasOwnProperty("blurRegions")) {
                        ...
                        for (var i = 0; i < message.blurRegions.length; ++i) {
                            var error = $root.android.surfaceflinger.BlurRegion.verify(message.blurRegions[i], long + 1);
                            if (error)
                    ...
                    if (message.destinationFrame != null && message.hasOwnProperty("destinationFrame")) {
                        var error = $root.android.surfaceflinger.RectProto.verify(message.destinationFrame, long + 1);
                        if (error)
                 ...
                 * @returns {android.surfaceflinger.LayerProto} LayerProto
                 */
                LayerProto.fromObject = function fromObject(object, long) {
                    ...
                    if (object.transparentRegion != null) {
                        ...
                        message.transparentRegion = $root.android.surfaceflinger.RegionProto.fromObject(object.transparentRegion, long + 1);
                    }
                    if (object.visibleRegion != null) {
                        ...
                        message.visibleRegion = $root.android.surfaceflinger.RegionProto.fromObject(object.visibleRegion, long + 1);
                    }
                    if (object.damageRegion != null) {
                        ...
                        message.damageRegion = $root.android.surfaceflinger.RegionProto.fromObject(object.damageRegion, long + 1);
                    }
                    ...
                    if (object.position != null) {
                        ...
                        message.position = $root.android.surfaceflinger.PositionProto.fromObject(object.position, long + 1);
                    }
                    if (object.requestedPosition != null) {
                        ...
                        message.requestedPosition = $root.android.surfaceflinger.PositionProto.fromObject(object.requestedPosition, long + 1);
                    }
                    if (object.size != null) {
                        if (typeof object.size !== "object")
                            throw TypeError(".android.surfaceflinger.LayerProto.size: object expected");
                        message.size = $root.android.surfaceflinger.SizeProto.fromObject(object.size, long + 1);
                    }
                    if (object.crop != null) {
                        if (typeof object.crop !== "object")
                            throw TypeError(".android.surfaceflinger.LayerProto.crop: object expected");
                        message.crop = $root.android.surfaceflinger.RectProto.fromObject(object.crop, long + 1);
                    }
                    if (object.finalCrop != null) {
                        ...
                        message.finalCrop = $root.android.surfaceflinger.RectProto.fromObject(object.finalCrop, long + 1);
                    }
                    ...
                    if (object.color != null) {
                        ...
                        message.color = $root.android.surfaceflinger.ColorProto.fromObject(object.color, long + 1);
                    }
                    if (object.requestedColor != null) {
                        ...
                        message.requestedColor = $root.android.surfaceflinger.ColorProto.fromObject(object.requestedColor, long + 1);
                    }
                    ...
                    if (object.transform != null) {
                        ...
                        message.transform = $root.android.surfaceflinger.TransformProto.fromObject(object.transform, long + 1);
                    }
                    if (object.requestedTransform != null) {
                        ...
                        message.requestedTransform = $root.android.surfaceflinger.TransformProto.fromObject(object.requestedTransform, long + 1);
                    }
                    ...
                    if (object.activeBuffer != null) {
                        ...
                        message.activeBuffer = $root.android.surfaceflinger.ActiveBufferProto.fromObject(object.activeBuffer, long + 1);
                    }
                    ...
                    if (object.hwcFrame != null) {
                        ...
                        message.hwcFrame = $root.android.surfaceflinger.RectProto.fromObject(object.hwcFrame, long + 1);
                    }
                    if (object.hwcCrop != null) {
                        ...
                        message.hwcCrop = $root.android.surfaceflinger.FloatRectProto.fromObject(object.hwcCrop, long + 1);
                    }
                    ...
                    if (object.barrierLayer) {
                        ...
                        for (var i = 0; i < object.barrierLayer.length; ++i) {
                            ...
                            message.barrierLayer[i] = $root.android.surfaceflinger.BarrierLayerProto.fromObject(object.barrierLayer[i], long + 1);
                        }
                    }
                    if (object.bufferTransform != null) {
                        ...
                        message.bufferTransform = $root.android.surfaceflinger.TransformProto.fromObject(object.bufferTransform, long + 1);
                    }
                    ...
                    if (object.effectiveTransform != null) {
                        ...
                        message.effectiveTransform = $root.android.surfaceflinger.TransformProto.fromObject(object.effectiveTransform, long + 1);
                    }
                    if (object.sourceBounds != null) {
                        ...
                        message.sourceBounds = $root.android.surfaceflinger.FloatRectProto.fromObject(object.sourceBounds, long + 1);
                    }
                    if (object.bounds != null) {
                        ...
                        message.bounds = $root.android.surfaceflinger.FloatRectProto.fromObject(object.bounds, long + 1);
                    }
                    if (object.screenBounds != null) {
                        ...
                        message.screenBounds = $root.android.surfaceflinger.FloatRectProto.fromObject(object.screenBounds, long + 1);
                    }
                    if (object.inputWindowInfo != null) {
                        ...
                        message.inputWindowInfo = $root.android.surfaceflinger.InputWindowInfoProto.fromObject(object.inputWindowInfo, long + 1);
                    }
                    if (object.cornerRadiusCrop != null) {
                        ...
                        message.cornerRadiusCrop = $root.android.surfaceflinger.FloatRectProto.fromObject(object.cornerRadiusCrop, long + 1);
                    }
                    ...
                    if (object.colorTransform != null) {
                        ...
                        message.colorTransform = $root.android.surfaceflinger.ColorTransformProto.fromObject(object.colorTransform, long + 1);
                    }
                    ...
                    if (object.blurRegions) {
                        ...
                        for (var i = 0; i < object.blurRegions.length; ++i) {
                            ...
                            message.blurRegions[i] = $root.android.surfaceflinger.BlurRegion.fromObject(object.blurRegions[i], long + 1);
                        }
                    }
                    ...
                    if (object.destinationFrame != null) {
                        ...
                        message.destinationFrame = $root.android.surfaceflinger.RectProto.fromObject(object.destinationFrame, long + 1);
                    }
            ...
            surfaceflinger.PositionProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                PositionProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                PositionProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {android.surfaceflinger.PositionProto} PositionProto
                 */
                PositionProto.fromObject = function fromObject(object, long) {
            ...
            surfaceflinger.FloatRectProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                FloatRectProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                FloatRectProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {android.surfaceflinger.FloatRectProto} FloatRectProto
                 */
                FloatRectProto.fromObject = function fromObject(object, long) {
            ...
            surfaceflinger.ActiveBufferProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                ActiveBufferProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                ActiveBufferProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {android.surfaceflinger.ActiveBufferProto} ActiveBufferProto
                 */
                ActiveBufferProto.fromObject = function fromObject(object, long) {
            ...
            surfaceflinger.BarrierLayerProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                BarrierLayerProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                BarrierLayerProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {android.surfaceflinger.BarrierLayerProto} BarrierLayerProto
                 */
                BarrierLayerProto.fromObject = function fromObject(object, long) {
            ...
            surfaceflinger.RegionProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                RegionProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                    ...
                    while (reader.pos < end) {
                        ...
                        case 2: {
                                if (!(message.rect && message.rect.length))
                                    message.rect = [];
                                message.rect.push($root.android.surfaceflinger.RectProto.decode(reader, reader.uint32(), undefined, long + 1));
                                break;
                            }
                        default:
                            reader.skipType(tag & 7, long);
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                RegionProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                    ...
                    if (message.rect != null && message.hasOwnProperty("rect")) {
                        ...
                        for (var i = 0; i < message.rect.length; ++i) {
                            var error = $root.android.surfaceflinger.RectProto.verify(message.rect[i], long + 1);
                            if (error)
                                return "rect." + error;
                        }
                    }
                 ...
                 * @returns {android.surfaceflinger.RegionProto} RegionProto
                 */
                RegionProto.fromObject = function fromObject(object, long) {
                    ...
                    if (object.rect) {
                        ...
                        for (var i = 0; i < object.rect.length; ++i) {
                            ...
                            message.rect[i] = $root.android.surfaceflinger.RectProto.fromObject(object.rect[i], long + 1);
                        }
                    }
                    return message;
                };
            ...
            surfaceflinger.RectProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                RectProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                RectProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {android.surfaceflinger.RectProto} RectProto
                 */
                RectProto.fromObject = function fromObject(object, long) {
            ...
            surfaceflinger.SizeProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                SizeProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                SizeProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {android.surfaceflinger.SizeProto} SizeProto
                 */
                SizeProto.fromObject = function fromObject(object, long) {
            ...
            surfaceflinger.TransformProto = (function() {
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                TransformProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
            ...
            surfaceflinger.ColorProto = (function() {
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                ColorProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
            ...
            surfaceflinger.InputWindowInfoProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                InputWindowInfoProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                    ...
                    while (reader.pos < end) {
                        ...
                        case 3: {
                                message.frame = $root.android.surfaceflinger.RectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 4: {
                                message.touchableRegion = $root.android.surfaceflinger.RegionProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 5: {
                        ...
                        case 15: {
                                message.touchableRegionCrop = $root.android.surfaceflinger.RectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 16: {
                                message.transform = $root.android.surfaceflinger.TransformProto.decode(reader, reader.uint32(), undefined, long + 1);
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                InputWindowInfoProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                    ...
                    if (message.frame != null && message.hasOwnProperty("frame")) {
                        var error = $root.android.surfaceflinger.RectProto.verify(message.frame, long + 1);
                        if (error)
                            return "frame." + error;
                    }
                    if (message.touchableRegion != null && message.hasOwnProperty("touchableRegion")) {
                        var error = $root.android.surfaceflinger.RegionProto.verify(message.touchableRegion, long + 1);
                        if (error)
                    ...
                    if (message.touchableRegionCrop != null && message.hasOwnProperty("touchableRegionCrop")) {
                        var error = $root.android.surfaceflinger.RectProto.verify(message.touchableRegionCrop, long + 1);
                        if (error)
                 ...
                 * @returns {android.surfaceflinger.InputWindowInfoProto} InputWindowInfoProto
                 */
                InputWindowInfoProto.fromObject = function fromObject(object, long) {
                    ...
                    if (object.frame != null) {
                        ...
                        message.frame = $root.android.surfaceflinger.RectProto.fromObject(object.frame, long + 1);
                    }
                    if (object.touchableRegion != null) {
                        ...
                        message.touchableRegion = $root.android.surfaceflinger.RegionProto.fromObject(object.touchableRegion, long + 1);
                    }
                    ...
                    if (object.touchableRegionCrop != null) {
                        ...
                        message.touchableRegionCrop = $root.android.surfaceflinger.RectProto.fromObject(object.touchableRegionCrop, long + 1);
                    }
                    if (object.transform != null) {
                        if (typeof object.transform !== "object")
            ...
            surfaceflinger.BlurRegion = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                BlurRegion.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                BlurRegion.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {android.surfaceflinger.BlurRegion} BlurRegion
                 */
                BlurRegion.fromObject = function fromObject(object, long) {
            ...
            surfaceflinger.ColorTransformProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                ColorTransformProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                ColorTransformProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {android.surfaceflinger.ColorTransformProto} ColorTransformProto
                 */
                ColorTransformProto.fromObject = function fromObject(object, long) {
            ...
            surfaceflinger.DisplayProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                DisplayProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                    ...
                    while (reader.pos < end) {
                        ...
                        case 5: {
                                message.layerStackSpaceRect = $root.android.surfaceflinger.RectProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 6: {
                                message.transform = $root.android.surfaceflinger.TransformProto.decode(reader, reader.uint32(), undefined, long + 1);
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                DisplayProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                    ...
                    if (message.layerStackSpaceRect != null && message.hasOwnProperty("layerStackSpaceRect")) {
                        var error = $root.android.surfaceflinger.RectProto.verify(message.layerStackSpaceRect, long + 1);
                        if (error)
                 ...
                 * @returns {android.surfaceflinger.DisplayProto} DisplayProto
                 */
                DisplayProto.fromObject = function fromObject(object, long) {
                    ...
                    if (object.layerStackSpaceRect != null) {
                        ...
                        message.layerStackSpaceRect = $root.android.surfaceflinger.RectProto.fromObject(object.layerStackSpaceRect, long + 1);
                    }
                    if (object.transform != null) {
                        if (typeof object.transform !== "object")
