                ...
                app.viewcapture = (function() {
                    ...
                    viewcapture.data = (function() {
                        ...
                        data.ExportedData = (function() {
                             ...
                             */
                            ExportedData.decode = function decode(reader, length, error, long) {
                                ...
                                while (reader.pos < end) {
                                    ...
                                    case 2: {
                                            if (!(message.windowData && message.windowData.length))
                                                message.windowData = [];
                                            message.windowData.push($root.com.android.app.viewcapture.data.WindowData.decode(reader, reader.uint32(), undefined, long + 1));
                                            break;
                                        }
                                    case 3: {
                             ...
                             */
                            ExportedData.verify = function verify(message, long) {
                                ...
                                if (message.windowData != null && message.hasOwnProperty("windowData")) {
                                    ...
                                    for (var i = 0; i < message.windowData.length; ++i) {
                                        var error = $root.com.android.app.viewcapture.data.WindowData.verify(message.windowData[i], long + 1);
                                        if (error)
                             ...
                             * @returns {com.android.app.viewcapture.data.ExportedData} ExportedData
                             */
                            ExportedData.fromObject = function fromObject(object, long) {
                                ...
                                if (object.windowData) {
                                    ...
                                    for (var i = 0; i < object.windowData.length; ++i) {
                                        ...
                                        message.windowData[i] = $root.com.android.app.viewcapture.data.WindowData.fromObject(object.windowData[i], long + 1);
                                    }
                                }
                        ...
                        data.WindowData = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            WindowData.decode = function decode(reader, length, error, long) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                if (long === undefined)
                                    long = 0;
                                ...
                                while (reader.pos < end) {
                                    ...
                                    case 1: {
                                            if (!(message.frameData && message.frameData.length))
                                                message.frameData = [];
                                            message.frameData.push($root.com.android.app.viewcapture.data.FrameData.decode(reader, reader.uint32(), undefined, long + 1));
                                            break;
                                        }
                                    case 2: {
                             ...
                             * @returns {string|null} `null` if valid, otherwise the reason why it is not
                             */
                            WindowData.verify = function verify(message, long) {
                                if (typeof message !== "object" || message === null)
                                    return "object expected";
                                if (long === undefined)
                                    long = 0;
                                ...
                                if (message.frameData != null && message.hasOwnProperty("frameData")) {
                                    ...
                                    for (var i = 0; i < message.frameData.length; ++i) {
                                        var error = $root.com.android.app.viewcapture.data.FrameData.verify(message.frameData[i], long + 1);
                                        if (error)
                             ...
                             * @returns {com.android.app.viewcapture.data.WindowData} WindowData
                             */
                            WindowData.fromObject = function fromObject(object, long) {
                                ...
                                if (object.frameData) {
                                    ...
                                    for (var i = 0; i < object.frameData.length; ++i) {
                                        ...
                                        message.frameData[i] = $root.com.android.app.viewcapture.data.FrameData.fromObject(object.frameData[i], long + 1);
                                    }
                                }
                        ...
                        data.MotionWindowData = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            MotionWindowData.decode = function decode(reader, length, error, long) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                if (long === undefined)
                                    long = 0;
                             ...
                             * @returns {string|null} `null` if valid, otherwise the reason why it is not
                             */
                            MotionWindowData.verify = function verify(message, long) {
                                if (typeof message !== "object" || message === null)
                                    return "object expected";
                                if (long === undefined)
                                    long = 0;
                             ...
                             * @returns {com.android.app.viewcapture.data.MotionWindowData} MotionWindowData
                             */
                            MotionWindowData.fromObject = function fromObject(object, long) {
                        ...
                        data.FrameData = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            FrameData.decode = function decode(reader, length, error, long) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                if (long === undefined)
                                    long = 0;
                                ...
                                while (reader.pos < end) {
                                    ...
                                    case 2: {
                                            message.node = $root.com.android.app.viewcapture.data.ViewNode.decode(reader, reader.uint32(), undefined, long + 1);
                                            break;
                                        }
                                    default:
                                        reader.skipType(tag & 7, long);
                             ...
                             * @returns {string|null} `null` if valid, otherwise the reason why it is not
                             */
                            FrameData.verify = function verify(message, long) {
                                if (typeof message !== "object" || message === null)
                                    return "object expected";
                                if (long === undefined)
                                    long = 0;
                                ...
                                if (message.node != null && message.hasOwnProperty("node")) {
                                    var error = $root.com.android.app.viewcapture.data.ViewNode.verify(message.node, long + 1);
                                    if (error)
                                        return "node." + error;
                                }
                                return null;
                             ...
                             * @returns {com.android.app.viewcapture.data.FrameData} FrameData
                             */
                            FrameData.fromObject = function fromObject(object, long) {
                                ...
                                if (object.node != null) {
                                    ...
                                    message.node = $root.com.android.app.viewcapture.data.ViewNode.fromObject(object.node, long + 1);
                                }
                                return message;
                            };
                        ...
                        data.ViewNode = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            ViewNode.decode = function decode(reader, length, error, long) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                if (long === undefined)
                                    long = 0;
                                ...
                                while (reader.pos < end) {
                                    ...
                                    case 3: {
                                            if (!(message.children && message.children.length))
                                                message.children = [];
                                            message.children.push($root.com.android.app.viewcapture.data.ViewNode.decode(reader, reader.uint32(), undefined, long + 1));
                                            break;
                                        }
                                    case 4: {
                             ...
                             * @returns {string|null} `null` if valid, otherwise the reason why it is not
                             */
                            ViewNode.verify = function verify(message, long) {
                                if (typeof message !== "object" || message === null)
                                    return "object expected";
                                if (long === undefined)
                                    long = 0;
                                ...
                                if (message.children != null && message.hasOwnProperty("children")) {
                                    ...
                                    for (var i = 0; i < message.children.length; ++i) {
                                        var error = $root.com.android.app.viewcapture.data.ViewNode.verify(message.children[i], long + 1);
                                        if (error)
                             ...
                             * @returns {com.android.app.viewcapture.data.ViewNode} ViewNode
                             */
                            ViewNode.fromObject = function fromObject(object, long) {
                                ...
                                if (object.children) {
                                    ...
                                    for (var i = 0; i < object.children.length; ++i) {
                                        ...
                                        message.children[i] = $root.com.android.app.viewcapture.data.ViewNode.fromObject(object.children[i], long + 1);
                                    }
                                }
                                if (object.id != null)
