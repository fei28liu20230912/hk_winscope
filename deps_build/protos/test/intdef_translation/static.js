    ...
    $root.winscope = (function() {
        ...
        winscope.test = (function() {
            ...
            test.RootMessage = (function() {
                 ...
                 */
                RootMessage.decode = function decode(reader, length, error, long) {
                    ...
                    while (reader.pos < end) {
                        ...
                        switch (tag >>> 3) {
                        case 1: {
                                message.intdefMappingEntry = $root.winscope.test.InputWindowInfoProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        case 2: {
                                message.windowLayoutParams = $root.winscope.test.WindowLayoutParamsProto.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        default:
                 ...
                 */
                RootMessage.verify = function verify(message, long) {
                    ...
                    if (message.intdefMappingEntry != null && message.hasOwnProperty("intdefMappingEntry")) {
                        var error = $root.winscope.test.InputWindowInfoProto.verify(message.intdefMappingEntry, long + 1);
                        if (error)
                            return "intdefMappingEntry." + error;
                    }
                    if (message.windowLayoutParams != null && message.hasOwnProperty("windowLayoutParams")) {
                        var error = $root.winscope.test.WindowLayoutParamsProto.verify(message.windowLayoutParams, long + 1);
                        if (error)
                 ...
                 * @returns {winscope.test.RootMessage} RootMessage
                 */
                RootMessage.fromObject = function fromObject(object, long) {
                    ...
                    if (object.intdefMappingEntry != null) {
                        ...
                        message.intdefMappingEntry = $root.winscope.test.InputWindowInfoProto.fromObject(object.intdefMappingEntry, long + 1);
                    }
                    if (object.windowLayoutParams != null) {
                        ...
                        message.windowLayoutParams = $root.winscope.test.WindowLayoutParamsProto.fromObject(object.windowLayoutParams, long + 1);
                    }
                    return message;
                };
            ...
            test.WindowLayoutParamsProto = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                WindowLayoutParamsProto.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                WindowLayoutParamsProto.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {winscope.test.WindowLayoutParamsProto} WindowLayoutParamsProto
                 */
                WindowLayoutParamsProto.fromObject = function fromObject(object, long) {
