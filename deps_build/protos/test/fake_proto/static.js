    ...
    $root.winscope = (function() {
        ...
        winscope.test = (function() {
            ...
            test.RootMessage = (function() {
                ...
                RootMessage.decode = function decode(reader, length, error, long) {
                    ...
                    while (reader.pos < end) {
                        ...
                        switch (tag >>> 3) {
                        case 1: {
                                message.entry = $root.winscope.test.Entry.decode(reader, reader.uint32(), undefined, long + 1);
                                break;
                            }
                        default:
                ...
                RootMessage.verify = function verify(message, long) {
                    ...
                    if (message.entry != null && message.hasOwnProperty("entry")) {
                        var error = $root.winscope.test.Entry.verify(message.entry, long + 1);
                        if (error)
                            return "entry." + error;
                    }
                    return null;
                ...
                RootMessage.fromObject = function fromObject(object, long) {
                    ...
                    if (object.entry != null) {
                        ...
                        message.entry = $root.winscope.test.Entry.fromObject(object.entry, long + 1);
                    }
                    return message;
                };
            ...
            test.Entry = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Entry.decode = function decode(reader, length, error, long) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {string|null} `null` if valid, otherwise the reason why it is not
                 */
                Entry.verify = function verify(message, long) {
                    if (typeof message !== "object" || message === null)
                        return "object expected";
                    if (long === undefined)
                        long = 0;
                 ...
                 * @returns {winscope.test.Entry} Entry
                 */
                Entry.fromObject = function fromObject(object, long) {
