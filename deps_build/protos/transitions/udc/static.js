                ...
                server.wm = (function() {
                    ...
                    wm.shell = (function() {
                        ...
                        shell.TransitionTraceProto = (function() {
                             ...
                             */
                            TransitionTraceProto.decode = function decode(reader, length, error, long) {
                                ...
                                while (reader.pos < end) {
                                    ...
                                    case 2: {
                                            if (!(message.transitions && message.transitions.length))
                                                message.transitions = [];
                                            message.transitions.push($root.com.android.server.wm.shell.Transition.decode(reader, reader.uint32(), undefined, long + 1));
                                            break;
                                        }
                                    case 3: {
                             ...
                             */
                            TransitionTraceProto.verify = function verify(message, long) {
                                ...
                                if (message.transitions != null && message.hasOwnProperty("transitions")) {
                                    ...
                                    for (var i = 0; i < message.transitions.length; ++i) {
                                        var error = $root.com.android.server.wm.shell.Transition.verify(message.transitions[i], long + 1);
                                        if (error)
                             ...
                             * @returns {com.android.server.wm.shell.TransitionTraceProto} TransitionTraceProto
                             */
                            TransitionTraceProto.fromObject = function fromObject(object, long) {
                                ...
                                if (object.transitions) {
                                    ...
                                    for (var i = 0; i < object.transitions.length; ++i) {
                                        ...
                                        message.transitions[i] = $root.com.android.server.wm.shell.Transition.fromObject(object.transitions[i], long + 1);
                                    }
                                }
                        ...
                        shell.Transition = (function() {
                             ...
                             * @throws {$protobuf.util.ProtocolError} If required fields are missing
                             */
                            Transition.decode = function decode(reader, length, error, long) {
                                if (!(reader instanceof $Reader))
                                    reader = $Reader.create(reader);
                                if (long === undefined)
                                    long = 0;
                                ...
                                while (reader.pos < end) {
                                    ...
                                    case 8: {
                                            if (!(message.targets && message.targets.length))
                                                message.targets = [];
                                            message.targets.push($root.com.android.server.wm.shell.Target.decode(reader, reader.uint32(), undefined, long + 1));
                                            break;
                                        }
                                    case 9: {
                             ...
                             * @returns {string|null} `null` if valid, otherwise the reason why it is not
                             */
                            Transition.verify = function verify(message, long) {
                                if (typeof message !== "object" || message === null)
                                    return "object expected";
                                if (long === undefined)
                                    long = 0;
                                ...
                                if (message.targets != null && message.hasOwnProperty("targets")) {
                                    ...
                                    for (var i = 0; i < message.targets.length; ++i) {
                                        var error = $root.com.android.server.wm.shell.Target.verify(message.targets[i], long + 1);
                                        if (error)
                             ...
                             * @returns {com.android.server.wm.shell.Transition} Transition
                             */
                            Transition.fromObject = function fromObject(object, long) {
                                ...
                                if (object.targets) {
                                    ...
                                    for (var i = 0; i < object.targets.length; ++i) {
                                        ...
                                        message.targets[i] = $root.com.android.server.wm.shell.Target.fromObject(object.targets[i], long + 1);
                                    }
                                }
            ...
            android.wm = (function() {
                ...
                wm.shell = (function() {
                    ...
                    shell.WmShellTransitionTraceProto = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        WmShellTransitionTraceProto.decode = function decode(reader, length, error, long) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                            if (long === undefined)
                                long = 0;
                            ...
                            while (reader.pos < end) {
                                ...
                                case 2: {
                                        if (!(message.transitions && message.transitions.length))
                                            message.transitions = [];
                                        message.transitions.push($root.com.android.wm.shell.Transition.decode(reader, reader.uint32(), undefined, long + 1));
                                        break;
                                    }
                                case 3: {
                                        if (!(message.handlerMappings && message.handlerMappings.length))
                                            message.handlerMappings = [];
                                        message.handlerMappings.push($root.com.android.wm.shell.HandlerMapping.decode(reader, reader.uint32(), undefined, long + 1));
                                        break;
                                    }
                                case 4: {
                                        message.realToElapsedTimeOffsetNanos = reader.fixed64();
                         ...
                         * @returns {string|null} `null` if valid, otherwise the reason why it is not
                         */
                        WmShellTransitionTraceProto.verify = function verify(message, long) {
                            if (typeof message !== "object" || message === null)
                                return "object expected";
                            if (long === undefined)
                                long = 0;
                            ...
                            if (message.transitions != null && message.hasOwnProperty("transitions")) {
                                if (!Array.isArray(message.transitions))
                                    return "transitions: array expected";
                                for (var i = 0; i < message.transitions.length; ++i) {
                                    var error = $root.com.android.wm.shell.Transition.verify(message.transitions[i], long + 1);
                                    if (error)
                                        return "transitions." + error;
                                }
                            }
                            if (message.handlerMappings != null && message.hasOwnProperty("handlerMappings")) {
                                ...
                                for (var i = 0; i < message.handlerMappings.length; ++i) {
                                    var error = $root.com.android.wm.shell.HandlerMapping.verify(message.handlerMappings[i], long + 1);
                                    if (error)
                         ...
                         * @returns {com.android.wm.shell.WmShellTransitionTraceProto} WmShellTransitionTraceProto
                         */
                        WmShellTransitionTraceProto.fromObject = function fromObject(object, long) {
                            ...
                            if (object.transitions) {
                                ...
                                for (var i = 0; i < object.transitions.length; ++i) {
                                    ...
                                    message.transitions[i] = $root.com.android.wm.shell.Transition.fromObject(object.transitions[i], long + 1);
                                }
                            }
                            if (object.handlerMappings) {
                                ...
                                for (var i = 0; i < object.handlerMappings.length; ++i) {
                                    ...
                                    message.handlerMappings[i] = $root.com.android.wm.shell.HandlerMapping.fromObject(object.handlerMappings[i], long + 1);
                                }
                            }
                            if (object.realToElapsedTimeOffsetNanos != null)
                                if ($util.Long)
                    ...
                    shell.HandlerMapping = (function() {
                         ...
                         * @throws {$protobuf.util.ProtocolError} If required fields are missing
                         */
                        HandlerMapping.decode = function decode(reader, length, error, long) {
                            if (!(reader instanceof $Reader))
                                reader = $Reader.create(reader);
                            if (long === undefined)
                                long = 0;
                         ...
                         * @returns {string|null} `null` if valid, otherwise the reason why it is not
                         */
                        HandlerMapping.verify = function verify(message, long) {
                            if (typeof message !== "object" || message === null)
                                return "object expected";
                            if (long === undefined)
                                long = 0;
                         ...
                         * @returns {com.android.wm.shell.HandlerMapping} HandlerMapping
                         */
                        HandlerMapping.fromObject = function fromObject(object, long) {
